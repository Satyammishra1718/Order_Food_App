...
export default function Login() {
    ...
    const handleSubmit = async(e)=>{
      ...
      if (!json.success) {
        setError(json.error || json.errors[0].msg);
      }else {
        setError("");
        await localStorage.setItem("userEmail", credentials.email);
    ...
    return (
      <div className='img_log' style={{backgroundImage: 'url("https://images.pexels.com/photos/326278/pexels-photo-326278.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")', height: '100vh', backgroundSize: 'cover' }}>
        <div>
          <CustomNavbar />
        </div>
